...
const trafficShares = [
    { id: 1, label: "Bank Payments", value: 60, color: "secondary", icon: faDesktop },
    { id: 2, label: "C2B", value: 30, color: "primary", icon: faMobileAlt },
    { id: 3, label: "B2B ", value: 10, color: "tertiary", icon: faTabletAlt }
];
